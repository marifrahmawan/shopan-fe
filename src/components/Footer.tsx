...
const Footer = () => {
  return (
    <div className="bg-black px-5 pb-8 pt-20 lg:px-40">
      <div className="flex flex-col justify-between md:flex-row">
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="h-10 w-10 rounded-full bg-white ">
            <img src={shopanLogo} alt="shopan logo" className="h-full w-full" />
          </div>
          <p className="mt-4 flex h-10 items-center border-t text-[14px] text-neutral-1 md:ml-8 md:mt-0 md:border-l md:border-t-0 md:pl-10">
            Gift & Decoration Store
          </p>
        </div>

        <div className="flex flex-col md:flex-row mt-10 md:mt-0 w-full md:w-fit items-center justify-center md:justify-end gap-10 text-[14px] text-neutral-1">
          <a href="./">Home</a>
          <a href="./">Shop</a>
          <a href="./">Product</a>
          <a href="./">Blog</a>
      ...
      <div className="mt-12 flex flex-col-reverse md:flex-row items-center justify-between border-t border-neutral-4 py-4 text-[14px] text-neutral-1 pb-12 md:pb-4">
